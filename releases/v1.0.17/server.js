...
<div class="ev-content">
  ...
  <div class="ev-panel" id="tab-oppmote">
    <div class="ev-card">
      ...
      <div id="regCounter" style="text-align:center;color:#555;font-size:.85rem;margin-top:.75rem">${regs.filter(r=>!r.anonymized).length} påmeldte · ${regs.filter(r=>r.checkedIn&&!r.anonymized).length} sjekket inn</div>
    </div>
  </div>
...
<div class="ev-content">
  ...
  <div class="ev-panel" id="tab-oppmote">
    <div class="ev-card">
      ...
      <div id="regCounter" style="text-align:center;color:#555;font-size:.85rem;margin-top:.75rem">

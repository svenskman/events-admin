...
<style>
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  #slideProgress{position:absolute;bottom:0;left:0;height:3px;background:${accent};transition:width 0s linear;opacity:.6}
  ...
  #drumRoll{font-size:clamp(1rem,3vw,1.8rem);color:#888;letter-spacing:.15em;text-transform:uppercase;margin-bottom:1.5rem;min-height:2rem}
  #winnerReveal{opacity:0;transform:scale(.7);transition:opacity .6s ease,transform .6s ease}
  ...
  /* TICKER */
  #ticker{position:absolute;bottom:0;left:0;right:0;background:rgba(0,0,0,.8);padding:.35rem 0;overflow:hidden;height:2.2rem;display:none;z-index:5}
  #tickerInner{white-space:nowrap;display:inline-block;font-size:.9rem;color:#aaa;padding-left:100%}
...
var state  = { mode:"slides", slide:0, slides:[], ticker:"", winnerName:"", prize:"", slideInterval:10, winnerDuration:300 };
...
function renderTicker() {
  ...
  if (state.ticker) {
    ...
    var txt = state.ticker + "     •     ";
    tickerInner.textContent = txt + txt; // doubled for seamless loop
    var dur = Math.max(12, state.ticker.length * .35);
    tickerInner.style.animation = "scrollTicker " + dur + "s linear infinite";
  } else {
